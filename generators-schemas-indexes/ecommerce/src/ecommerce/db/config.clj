...
(defn create-sample-data!
  ...
  (pprint @(db.category/upsert! connection [eletronics, sports]))
  ...
  (pprint @(db.product/upsert! connection [computer, phone, cheap-phone, chess, game]))

  (db.category/assign! connection [computer, phone, cheap-phone, game] eletronics)
  (db.category/assign! connection [chess] sports)

  (db.sell/insert! connection (:product/id computer) 3)
  (db.sell/insert! connection (:product/id computer) 4)
  (db.sell/insert! connection (:product/id computer) 8))